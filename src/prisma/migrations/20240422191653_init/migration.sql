...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_productRequestId_fkey" FOREIGN KEY ("productRequestId") REFERENCES "Feedback"("id") ON DELETE SET NULL ON UPDATE CASCADE;
